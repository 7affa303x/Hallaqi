...
export const settingsSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'testimonials', label: 'شهادات عملاء', icon: 'Star', description: 'من تقييمات حقيقية على المنصة', type: 'link' },
      { id: 'publicRoadmap', label: 'خارطة الطريق', icon: 'MapPin', description: 'ما متوفر وما قادم بشفافية', type: 'link' },
      { id: 'expansionGuide', label: 'توسّع الولايات', icon: 'Globe', description: 'مراحل الإطلاق الجغرافي', type: 'link' },
      { id: 'mentionsLegales', label: 'Mentions légales', icon: 'FileText', description: 'إشعار قانوني كامل', type: 'link' },
